...
dureCountryResponseObj.validateForm = function() {
  ...
  document.querySelectorAll('#country-response-form input[type=text]:required')
    ...
    document.querySelectorAll('#country-response-form input[type=email]:required')
    .forEach(function(e,i) {
    ...
    document.querySelectorAll('#country-response-form input[type=radio]:required')
    .forEach(function(e,i) {

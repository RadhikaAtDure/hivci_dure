...
ihealthMenu.getTargetMenuForTargetGroup = function (targetObj) {
  ...
  var targetMenuHtml = '<ul class="treeview-menu" style="display: block;">';
  ...
  /*targetMenuHtml += '<li class="">';
   targetMenuHtml += '<a href="#">'+
   '<i class="glyphicon glyphicon-th-list"></i><span>Drug Access</span>'+
   '</a>';
   targetMenuHtml += "</li>";
   
   targetMenuHtml += '<li class="">';
   targetMenuHtml += '<a href="https://aidsreportingtool.unaids.org/" target="_blank">'+
   '<i class="glyphicon glyphicon-th-list"></i><span>GARPR Data</span>'+
   '</a>';
   targetMenuHtml += "</li>";*/

  /*targetMenuHtml += '<li class="">';
   targetMenuHtml += '<a href="http://www.who-hivconsultantroster.net/" target="_blank">'+
